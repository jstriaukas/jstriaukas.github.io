...
\begin{document}
	...
	\hspace{2em} \href{https://jstriaukas.github.io/files/papers/factor_sparse_test.pdf}{pdf} \tikz \pic{linkpic};  \href{https://doi.org/10.1016/j.jeconom.2024.105845}{journal} \tikz \pic{linkpic};
	...
	\hspace{2em} \href{https://jstriaukas.github.io/files/papers/midas_ml_panel_earnings_nowcasting.pdf}{pdf} \tikz  \pic{linkpic}; \href{https://onlinelibrary.wiley.com/doi/10.1002/jae.3028}{journal} \tikz \pic{linkpic};
   ...
   \vspace{-0.5em}
	...
	\hspace{1em}``Factor-augmented sparse MIDAS regressions with an application to nowcasting''

	\hspace{2em} with J. Beyhum, accepted at Journal of Business \& Economic Statistics
	
	\hspace{2em} \href{https://arxiv.org/abs/2306.13362}{arxiv} \tikz \pic{linkpic};

	\smallskip

	\hspace{1em}``Nowcasting and aggregation: Why small Euro area countries matter'' 

	\hspace{2em} with A. Babii, L. Barbaglia and E. Ghysels, R\&R at Journal of Business \& Economic Statistics
	
	\hspace{2em} \href{https://arxiv.org/abs/2509.24780}{arxiv} \tikz \pic{linkpic};
	
	\smallskip
		
	\hspace{1em}``High-dimensional censored MIDAS logistic regression for corporate survival forecasting'' 
	
	\hspace{2em} with W. Miao, J. Beyhum and I. Van Keilegom, R\&R at Journal of Econometrics 
	
	\hspace{2em} \href{https://arxiv.org/abs/2502.09740}{arxiv} \tikz \pic{linkpic};

	\section*{Work in progress}
	\vspace{-0.5em}
	
	\hspace{1em}``Robust bond risk premia: sparse macroeconomic information matters''
	
	\hspace{2em} with  A. Luisi and F. Roccazzella
	
		\smallskip
	
	\hspace{1em}``Testing for covariate effects in tail index models''
	
	\hspace{2em} with A. Rønn-Nielsen and M. Stehr
	
	\smallskip
	
	\hspace{1em}``Hotter than OLS: LAVA-regularized portfolio optimization''
	
	\hspace{2em} with F. Jedmo 
	
	\smallskip
	
%	\hspace{1em}``Inference for tail-index regression models''
	
%	\hspace{2em} with A. Rønn-Nielsen, and  M. Stehr 
	
%	\smallskip 
%
	\hspace{1em} ``Sequential global testing''
	
	\hspace{2em} with M. Toyoda and Y. Uematsu
	
	\smallskip
%	
%	\hspace{1em} ``Factor-augmented sparse logistic MIDAS regression''
%	
%	\hspace{2em} with J. Beyhum and J. Koh
%	
%	\smallskip
%	
	\hspace{1em} ``Granger causality and networks''

	\hspace{2em} with  Y. Uematsu

	\smallskip

	\hspace{1em} ``The News Behind Market Activity"
	
	\hspace{2em} with  J. G. Roth
...
%	\hspace{2em} Master level, Forecasting with Eric Ghysels, 2018
	...
	\hspace{1em} Hitotsubashi University, Japan. September -- December, 2025
	
	\hspace{2em} Host: Yoshimasa Uematsu.
	
	\smallskip
	
	\hspace{1em} Universitat Pompeu Fabra, Spain. April -- July, 2023
	
	\hspace{2em} Host: Christian Brownlees.
	
	\smallskip
	
	\hspace{1em} Universitat Pompeu Fabra, Spain. January -- April, 2022
	
	\hspace{2em} Host: Gábor Lugosi.
	
	\smallskip
	
	\hspace{1em} University of North Carolina – Chapel Hill, United States. September 2018 \& 2019
	
	\hspace{2em} Host: Eric Ghysels.
	...
	\begin{itemize}[leftmargin=4.5em]
		...
		\item[2026:] Linnaeus University; Planned: Lund University; Conference on Advances in Causal Inference for Macroeconomic Policies (discussant); EcoSta(invited talk); Aarhus University
		\item[2025:] Goethe University Frankfurt; EcoSta (invited talk); CFE-CMStatistics\thestarnogap (invited talk).
		\item[2024:] CIREQ Econometrics Montreal; University of Copenhagen; Rotterdam University; The Winter Meeting of the Annual Lithuanian Conference on Economic Research.
		...
		\item[2021:] UNC PhD students econometrics workshop\thestarnogap; 3rd Baltic Economics Conference\thestarnogap; North American Summer Meeting of the Econometric Society\thestarnogap; SoFiE \thestarnogap; ECB workshop\thestarnogap; European Summer Meeting of the Econometric Society\thestarnogap; CFE\thestarnogap (invited talk).
...
\blfootnote{\thestar Online conference/seminar/lectures.} 
	...
	\vspace{-0.5em}
		\begin{itemize}[leftmargin=4.5em]
		\setlength\itemsep{-0.1em}
		\item[] \hspace{-2.85em}PhD co-advisor (in progress): 
		\item[] Mads Hebsgaard (Copenhagen Business School), Filip Jedmo (Copenhagen Business School, main advisor), Jan Gabriel Roth (Copenhagen Business School), Wei Miao (KU Leuven) 
		\setlength\itemsep{-0.1em}
...
%		\item[2023:] Rasmus Ahlberg, Oliver Bondrop \& Nicolai Reimer (ML methods), Abdullah Ahmed \& Minghao Wang (ML/finance), Jonas Ahooei (ML methods), Andreas Kjeldsen (ML forecasting), Caroline Hoff-Jessen (ML forecasting), Henrik Decker \& Adam Ferla (finmetrics), Kristian Ernst (ML forecasting), Alexander Bj{\o}rstrup Mogensen \& Philip Bruun Hansen (ML/finance), Sebastian Strauss Hansen (ML/finance).
	...
	\begin{itemize}[leftmargin=4.5em]
		...
		\item[2023-25:] Marie Skłodowska-Curie grant for $\approx$230.000 Eur, supervisor Rasmus Tangsgaard Varneskov; \\ %\href{https://macroml.cbs.dk}{website} \tikz \pic{linkpic};\\
	...
	\vspace{-0.5em}
	\hspace{1em}\textsc{Co-organizers of conferences and workshops}
	\vspace{-0.5em}
	\begin{itemize}[leftmargin=1.5em]
		\setlength\itemsep{-0.1em}
		\item[]  Workshop on``Machine Learning Economic Forecasting and Nowcasting'', April 2025, at Copenhagen Business School, with A. Babii, E. Ghysels, M. Marcelino and the Department of Finance, CBS. 
	\end{itemize}
	\vspace{-0.5em}
	...
	\begin{itemize}[leftmargin=1.5em]
		\setlength\itemsep{-0.1em}
		\item[] International Journal of Forecasting, Journal of Applied Econometrics, Journal of Econometrics, Journal of Empirical Finance, Journal of Financial Econometrics, Journal of Forecasting, Oxford Bulletin of Economics and Statistics,  PLoS ONE, Review of Economics and Statistics, The Econometrics Journal, The Review of Financial Studies
	\end{itemize}
	...
	\hspace{1em} R: FAS (\href{https://CRAN.R-project.org/package=FAS}{CRAN link} \tikz \pic{linkpic};), midasml (\href{https://CRAN.R-project.org/package=midasml}{CRAN link} \tikz \pic{linkpic};), LassoNet (\href{https://CRAN.R-project.org/package=LassoNet}{CRAN link} \tikz \pic{linkpic}; ) 
