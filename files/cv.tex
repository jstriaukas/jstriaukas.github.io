...
\begin{document}
	...
	\hspace{2em} with A. Babii, R. T. Ball and E. Ghysels, (2024+), \textit{Journal of Econometrics}. 
	...
	\hspace{2em} with A. Babii and E. Ghysels, (2024+), \textit{Journal of Financial Econometrics}. 
	...
	\hspace{2em} with A. Babii, R. Ball and E. Ghysels, \textit{Journal of Applied Econometrics}, 39(2), 292-307. 
   ...
   \vspace{-0.5em}
	\hspace{1em} Handbook of research methods and applications in macroeconomic forecasting, \textit{forthcoming}
	...
	\hspace{2em} with J. Beyhum, \href{https://jstriaukas.github.io/files/papers/tuning_free.pdf}{pdf} \tikz \pic{linkpic}; R\&R \textit{Journal of Econometrics}
...
%	\hspace{2em} Master level, Forecasting with Eric Ghysels, 2018
	...
	\begin{itemize}[leftmargin=4.5em]
		...
		\item[2024:] CIREQ Econometrics Montreal (scheduled) 
