...
\begin{document}
	...
	\vspace{-0.5em}
	\hspace{1em} (Robust) statistical learning methods for the dependent data, mixed frequency data econometric methods with applications in finance \& macroeconomics
	...
	\begin{itemize}[leftmargin=4.5em]
		\setlength\itemsep{-0.1em}
		\item[2022:] Euro Area Business Cycle Network lectures series\thestarnogap
		\item[2022-24:] F.R.S.-FNRS PDR grant for $\approx$160.000 Eur, joint with Rudy De Winne
		\item[2020:] SoFiE summer school, NYU/Shanghai\thestarnogap
		\item[2020:] SoFiE summer school, University of Chicago\thestarnogap
		\item[2019:] CORE lectures series
