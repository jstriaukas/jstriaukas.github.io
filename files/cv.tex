...
\begin{document}
   ...
   \vspace{-0.5em}
	...
	\hspace{1em}``A Test for the idiosyncratic component of the mean variance portfolio''
...
%	\hspace{2em} Master level, Forecasting with Eric Ghysels, 2018
	...
	\begin{itemize}[leftmargin=4.5em]
		...
		\item[2026:] Linnaeus University; Planned: Lund University; Conference on Advances in Causal Inference for Macroeconomic Policies (discussant); Aarhus University
