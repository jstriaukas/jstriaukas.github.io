...
\end{itemize}
	...
	\vspace{-0.5em}
		...
		\item[] Mads Hebsgaard (Copenhagen Business Schoo), Filip Jedmo (Copenhagen Business School, main advisor), Jan Gabriel Roth (Copenhagen Business School), Wei Miao (KU Leuven) 
		\setlength\itemsep{-0.1em}
