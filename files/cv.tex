...
\begin{document}
	...
	\begin{table}[!ht]
		\begin{tabular}{l p{6.0cm} r}
			...
			Finance Department& &{\faEnvelopeO}  \href{mailto:jonas.striaukas@gmail.com}
			{jost.fi[at]cbs.dk}\\
	...
	\hspace{2em} Visit supervisors: G{\'a}bor Lugosi \& Christian Brownlees
...
%	\hspace{2em} Master level, Forecasting with Eric Ghysels, 2018
	...
	\begin{itemize}[leftmargin=4.5em]
		\setlength\itemsep{-0.1em}
		\item[2022:]  Member of Danish Society for Theoretical Statistics (DSTS)
