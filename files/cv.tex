...
\begin{document}
   ...
   \vspace{-0.5em}
	...
	\hspace{2em} with A. Babii, L. Barbaglia and E. Ghysels, Rej\&R at Journal of Business \& Economic Statistics
	...
	\hspace{1em}``Efficiency test for the minimum variance portfolio''
...
%	\smallskip
%	
%	\hspace{1em} ``Tail risk Granger causality networks''
%
