...
\begin{document}
	...
	\hspace{2em} with A. Babii and E. Ghysels (2022), \textit{Journal of Business \& Economic Statistics}, 40, 1094–1106. 
	...
	\hspace{2em} with M. Weber, M. Schumacher and H. Binder, (2022), \textit{Journal of Applied Statistics}, 50(3), 535-554. 
	...
	\hspace{2em} with J. Beyhum, \href{https://jstriaukas.github.io/files/papers/tuning_free.pdf}{pdf} \tikz \pic{linkpic};
	
	\smallskip
	
	\hspace{1em}``Factor-augmented sparse MIDAS regression for nowcasting'' (updated version soon available)

	\hspace{2em} with J. Beyhum, \href{https://jstriaukas.github.io/files/papers/famidas_ml.pdf}{pdf} \tikz \pic{linkpic};
...
%	\hspace{2em} Master level, Forecasting with Eric Ghysels, 2018
	...
	\begin{itemize}[leftmargin=4.5em]
		...
		\item[2023:] Bank of Lithuania, Baltic Economic Conference 2023, EcoSta 2023, Compstat 2023, BI Norwegian Business School 
	...
	\vspace{-0.5em}
		...
		\item[] Jan Gabriel Roth (in progress), Wei Miao (in progress)
		\setlength\itemsep{-0.1em}
		\item[] \hspace{-2.85em}Master theses: 
		\item[2023:] Rasmus Ahlberg, Oliver Bondrop \& Nicolai Reimer (ML methods, in progress), Abdullah Ahmed \& Minghao Wang (ML/finance, in progress), Jonas Ahooei (ML methods, in progress), Andreas Kjeldsen (ML forecasting, in progress), Caroline Hoff-Jessen (ML forecasting, in progress), Henrik Decker \& Adam Ferla (finmetrics, in progress), Kristian Ernst (ML forecasting, in progress)
	\end{itemize}
