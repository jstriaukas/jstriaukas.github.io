...
%	\hspace{2em} Master level, Forecasting with Eric Ghysels, 2018
	...
	\vspace{-0.5em}
		...
		\item[2023:] Rasmus Ahlberg, Oliver Bondrop \& Nicolai Reimer (ML methods), Abdullah Ahmed \& Minghao Wang (ML/finance), Jonas Ahooei (ML methods), Andreas Kjeldsen (ML forecasting), Caroline Hoff-Jessen (ML forecasting), Henrik Decker \& Adam Ferla (finmetrics), Kristian Ernst (ML forecasting)
	\end{itemize}
	...
	\begin{itemize}[leftmargin=4.5em]
		\setlength\itemsep{-0.1em}
		\item[2023:] Workshop for Ukraine ``Introduction to mixed frequency data models in R"
